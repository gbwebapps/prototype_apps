<div class="row">
	<div class="col-md-6 offset-md-3">
		<div class="card mt-2">
			...
			<form id="customers_add" method="post">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<select name="type" id="type" class="form-control">
									...
									<option value="0">Private Client</option>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="customer" id="customer" placeholder="Insert the customer name here...">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="tax_code" id="tax_code" placeholder="Insert the tax code here...">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="email" id="email" placeholder="Insert the email here...">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="phone" id="phone" placeholder="Insert the phone here...">
