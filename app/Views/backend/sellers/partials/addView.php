<div class="row">
	<div class="col-md-8 offset-md-2">
		<div class="card mt-2">
			...
			<form id="sellers_add" method="post">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" name="firstname" id="firstname" placeholder="Insert the firstname here..." class="form-control" autofocus>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" name="lastname" id="lastname" placeholder="Insert the lastname here..." class="form-control">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" name="email" id="email" placeholder="Insert the email here..." class="form-control">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" name="phone" id="phone" placeholder="Insert the phone here..." class="form-control">
				                    ...
				                    <?php foreach($item['perms'] as $k => $v): ?>
				                        ...
				                        <div class="col-sm-6 col-md-4 col-lg-3 text-center py-1">
				                            <ul class="list-group list-group-flush">
				                                ...
				                                <li class="list-group-item">
				                                    <input type="checkbox" class="<?= $item['controller']; ?>" name="permissions[]" value="<?= $k; ?>" id="<?= $k; ?>">
				                                </li>
				                            </ul>
				                        </div>
